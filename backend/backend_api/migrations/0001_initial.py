    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctorid', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='backend_api.doctor')),
                ('roomid', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='backend_api.room')),
            ],
        ),
        migrations.CreateModel(
            name='Patient',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctorid', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='backend_api.doctor')),
                ('patientid', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='backend_api.patient')),
            ],
        ),
    ]
